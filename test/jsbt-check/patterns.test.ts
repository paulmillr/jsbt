...
import { __TEST as TSDOC_TEST } from '../../src/jsbt-check/jsdoc.ts';
import { __TEST, runCli } from '../../src/jsbt-check/patterns.ts';

const TMP = resolve('test/jsbt-check/build/patterns');
