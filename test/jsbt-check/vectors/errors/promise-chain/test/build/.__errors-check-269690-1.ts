...
import {
  privateKeyText,
  parsePrivateKey,
} from 'file:///home/user/Developer/personal/jsbt/test/jsbt/vectors/errors/promise-chain/index.js';
const seed = 'secret';
__jsbtCall(0, parsePrivateKey, undefined, [privateKeyText(seed).privateKey]);
