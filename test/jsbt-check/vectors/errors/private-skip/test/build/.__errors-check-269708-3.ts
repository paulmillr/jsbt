const __jsbtCases = [
  ...
  },
  {
    ...
    line: 76,
    missing: [false, false],
    name: 'secretFactory.create.open',
    ownerName: 'secretFactory.create',
    probe: [false, true],
  },
];
...
import { secretFactory } from 'file:///home/user/Developer/personal/jsbt/test/jsbt/vectors/errors/private-skip/index.js';
__jsbtCall(0, secretFactory, undefined, [new Uint8Array([1])]);
__jsbtMethod(1, () => secretFactory.create(new Uint8Array([2])), 'open', [new Uint8Array([3])]);
const __jsbtIssues = [];
const __jsbtRejects = [];
const __jsbtDocs =
