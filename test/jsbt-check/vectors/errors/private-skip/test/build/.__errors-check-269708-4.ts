...
import { Box } from 'file:///home/user/Developer/personal/jsbt/test/jsbt/vectors/errors/private-skip/index.js';
const box = __jsbtNew(0, Box, [new Uint8Array([1])]);
__jsbtMethod(1, () => box, 'open', ['tag', new Uint8Array([2])]);
const __jsbtIssues = [];
const __jsbtRejects = [];
const __jsbtDocs =
