...
const __jsbtPrivateClasses = new Set([]);
const __jsbtPrivateMethods = new Set([]);
...
import { normalize } from 'file:///home/user/Developer/personal/jsbt/test/jsbt/vectors/errors/label-param/index.js';
__jsbtCall(0, normalize, undefined, [new Uint8Array([1])]);
const __jsbtIssues = [];
const __jsbtRejects = [];
const __jsbtDocs =
